...
const FbDefaultForm = () => {
    ...
    const fetchBlogData = async () => {
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:9000/admin/Bepocart-Blog-update/${id}/`, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            let response;
            if (updateMode) {
                response = await axios.put(`http://127.0.0.1:9000/admin/Bepocart-Blog-update/${id}/`, formData, {
                    headers: {
                ...
                response = await axios.post("http://127.0.0.1:9000/admin/Bepocart-Blog-create/", formData, {
                    headers: {
                        'Content-Type': 'multipart/form-data',
                        'Authorization': `${token}`,
                    },
