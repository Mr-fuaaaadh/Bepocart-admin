...
const CoinTable = () => {
    ...
    const fetchCoins = async () => {
        ...
        try {
            ...
            const response = await axios.get(`http://127.0.0.1:9000/admin/Bepocart-user-coins/${id}/`, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
    ...
    const handleDelete = async () => {
        try {
            ...
            await axios.delete(`http://127.0.0.1:9000/admin/Bepocart-coin-delete/${deleteCoinId}/`, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
    ...
    const handleSaveEdit = async () => {
        try {
            const token = localStorage.getItem('token');
            await axios.put(`http://127.0.0.1:9000/admin/Bepocart-coin-update/${editCoinId}/`, {
