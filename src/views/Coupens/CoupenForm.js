...
const FbDefaultForm = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const productResponse = await axios.get("http://127.0.0.1:9000/admin/Bepocart-products/", {
                    headers: {
                        Authorization: `${token}`,
                    },
                });
                ...
                const categoryResponse = await axios.get("http://127.0.0.1:9000/admin/Bepocart-subcategories/", {
                    headers: {
                        Authorization: `${token}`,
                    },
                });
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('http://127.0.0.1:9000/admin/Bepocart-promotion-coupen/', formattedData, {
                headers: {
                    Authorization: `${token}`,
                },
            });
