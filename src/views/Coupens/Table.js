...
const TableBanner = () => {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const response = await axios.get("http://127.0.0.1:9000/admin/Bepocart-promotion-coupen-views/", {
                headers: {
                    'Authorization': `${token}`,
                },
            });
    ...
    const handleDelete = async (id) => {
        try {
            const token = localStorage.getItem('token');
            await axios.delete(`http://127.0.0.1:9000/admin/Bepocart-promotion-coupen-delete/${id}/`, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
