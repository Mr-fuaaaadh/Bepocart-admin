...
const FbDefaultForm = () => {
    ...
    const fetchCouponDetails = async () => {
        try {
            ...
            const response = await axios.get(`https://bepocart.in/admin/Bepocart-promotion-coupen-update/${id}/`, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://bepocart.in/admin/Bepocart-promotion-coupen-update/${id}/`, formData, {
                headers: {
                    'Authorization': `${token}`,
                },
            });
